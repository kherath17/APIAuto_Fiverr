...
public class removePhotoURL {
    @Test(priority = 0)
    void removePhoto() throws IOException, ParseException {
       ...
       RequestSpecification req =  given()
        ...
        Response resp = req.put("api/user/remove/photourl");
    ...
    @Test(priority = 1)
    void removePhoto_Negative() throws IOException, ParseException {
        ...
        Assert.assertTrue(resp.getTimeIn(TimeUnit.SECONDS)<=1);
        Assert.assertEquals(message,"The photo url is already removed");
    }
}
